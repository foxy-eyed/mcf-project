...
| Списание средств с клиентов | Microkernel (работа с платежными шлюзами может быть вынесена в плагины) | Реляционная БД |
| Комплектация заказов        | Layered monolith                                                        | Реляционная БД |
| Core-монолит                | Modular monolith                                                        | Реляционная БД |

Каждый из сервисов имеет собственную реляционную БД из-за требования CatFinComplience на уровне всей системы.
